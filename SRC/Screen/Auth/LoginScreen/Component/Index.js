...
export const HeaderButton = ({ headerPress, setHeaderPress }) => {
    return (
        <View style={styles.roleSelector}>
            ...
            >
                <View style={styles.roleButtonContent}>                    
                    <View style={[styles.roleIcon, { backgroundColor: headerPress === 'university' ? Color.WHITE : Color.SURFACE_DARK }]}>
            ...
            <View style={styles.inputSection}>
                ...
                <View style={styles.inputContainer}>
                    <InputText 
                        ...
                        rightIcon={true}
                        handleIconPress={() => setShowStudentPassword(!showStudentPassword)}
                        RightIconChildren={
                            <Icon 
...
export const UniversityLoginForm = ({UniversityPress,UniversityEmail,setUniversityEmail,universityPassword,setUniversityPassword,loading,showUniversityPassword, setShowUniversityPassword}) => {
    return (
        <View style={styles.formContainer}>
            <View style={styles.inputSection}>
            ...
            <View style={styles.inputSection}>
                ...
                <View style={styles.inputContainer}>
                    <InputText 
                        placeholder="Enter your password" 
                        secureTextEntry={!showUniversityPassword}
                        style={styles.inputField}
                        placeholderTextColor={Color.TEXT_LIGHT}
                        value={universityPassword}
                        onChangeText={setUniversityPassword}
                        rightIcon={true}
                        handleIconPress={() => setShowUniversityPassword(!showUniversityPassword)}
                        RightIconChildren={
                            <Icon 
                                name={showUniversityPassword ? "eye-off-outline" : "eye-outline"} 
                                size={22} 
                                color={Color.TEXT_SECONDARY} 
                            />
                        }
